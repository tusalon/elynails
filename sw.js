...
const CACHE_NAME = 'elynails-v49';
const urlsToCache = [
  '/elynails/',
  '/elynails/index.html',
  '/elynails/admin.html',
  '/elynails/admin-login.html',
  '/elynails/calendar.html',
  ...
  '/elynails/utils/push-config.js',
  '/elynails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/elynails/icons/icon-192x192.png',
    badge: '/elynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/elynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/elynails/admin.html';
  event.waitUntil(
